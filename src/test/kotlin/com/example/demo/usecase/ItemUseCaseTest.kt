...
class ItemUseCaseTest : DescribeSpec({
    ...
    describe("ItemUseCase"){
        ...
        it("should update item when ID exists") {
            ...
            StepVerifier.create(itemUseCase.update("123", updatedItem))
        ...
        it("should delete item by ID") {
            ...
            StepVerifier.create(itemUseCase.delete("123"))
                .verifyComplete()
        }
    }
})